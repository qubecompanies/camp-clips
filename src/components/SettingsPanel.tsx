  ...
  return (
    <div className="panel active" id="panel-settings">
      ...
      <div className="panel-section">
        ...
        <div className="panel-help">
          Adds gentle cinematic movement — a randomized mix of slow zooms and pans, biased to keep faces in frame.
          Tall portrait photos preserve their full frame; wider shots fill the screen.
        </div>
      </div>
